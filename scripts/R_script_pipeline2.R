...
write.csv(results_transcripts, "../results/genome_transcript_results2.csv", row.names=FALSE) 
write.csv(results_genes, "../results/genome_gene_results2.csv", row.names=FALSE) 
